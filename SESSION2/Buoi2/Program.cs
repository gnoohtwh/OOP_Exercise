...
4/ Bổ sung các phương thức sau: tính khoảng cách giữa 2 Point, kiểm tra một Point thuộc phần tư nào, kiểm tra 2 Point có dói xứng qua trục hoành không
5/ Trong hàm Mian, tạo ra một List các Point và in ra một bộ 3 Point tạo thành 1 tam giác ( chỉ cần in một bộ ba duy nhất). Phương tháuc này là static method trong class Program ( không phải thành viên của lớp Point). Và kiểm tra các methods trong câu số 4.
